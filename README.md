...
In my first analysis *PyCitySchools* you can see that when the analysis included (THS) ninth-grade math students the schools average passing math percentage was %93.87. Veiw table below for evidence. 
...
In my second analsysis when I replaced (THS) ninth-grade math class with "NaNs", the new average passing math percentage decreased to %66.91. Veiw table below for evidence. 
...
It can now be said that due to (THS) changing their ninth-grade math scores, the average score for students passing math increased but in reality it should've decreased because those scores weren't accurate represenation of the students true grades. 
